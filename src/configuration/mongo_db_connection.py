...
class MongoDBClient:
    ...
    def __init__(self, database_name: str = os.getenv('DATABASE_NAME')) -> None:
        """
        ...
        try:
            ...
            if MongoDBClient.client is None:
                mongo_db_url = os.getenv('MONGO_CLUSTER_URI') # Retrieve MongoDB URL from environment variables
